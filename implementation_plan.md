...
graph TD
    ...
    A -->|5. 종합 및 최종 문서 작성| E[dsp_curriculum.md]
```
...
3. **최종 통합 및 문서 작성:** 조율된 최종 안을 바탕으로 프로젝트 루트 밑의 [dsp_curriculum.md](dsp_curriculum.md)에 정밀하고 세부적인 커리큘럼 가이드를 작성합니다.
...
* **[NEW] [dsp_curriculum.md](dsp_curriculum.md):** 최종 협의된 로드맵 및 단계별 실무 학습 내용 정리 문서.
* **[README.md](README.md) 및 [_sidebar.md](_sidebar.md) 업데이트:** 신규 커리큘럼 문서를 위키 전면에 링크.
